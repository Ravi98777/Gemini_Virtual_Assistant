...
const handleSignIn = async(e)=>{
  ...
  return (
    ...
    >
      <form onSubmit={handleSignIn} className="w-[90%] max-w-md bg-[#00000035] backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8 flex flex-col gap-5">
        ...
        <p className="text-center text-gray-300 text-sm">
          ...
          <span className="text-cyan-400 cursor-pointer hover:underline" onClick={()=>navigate("/signup")}>
            Register
          </span>
        </p>
      </form>
